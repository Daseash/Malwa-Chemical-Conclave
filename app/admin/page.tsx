...
export default function AdminPage() {
  ...
  // ─────────────────────────────────────────────────────────────
  // 1. CLEAN ALL-WHITE LOGIN SCREEN
  // ─────────────────────────────────────────────────────────────
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md rounded-3xl border border-gray-200 bg-white p-8 sm:p-10 shadow-xl space-y-7">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="pt-2">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-navy-50 border border-navy/20 px-3.5 py-1 text-xs font-bold uppercase tracking-widest text-navy">
                <Lock size={12} /> Secretariat Access
              </span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4 pt-1">
            <div>
              <input
                ...
                className="w-full rounded-xl border border-gray-300 bg-gray-50/60 px-4 py-3.5 text-sm text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-navy focus:ring-2 focus:ring-navy/20 outline-none text-center tracking-wider transition-all"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-navy hover:bg-navy-900 py-3.5 px-4 text-sm font-bold text-white shadow-md transition-all cursor-pointer hover:scale-[1.01] active:scale-[0.99]"
            >
          ...
          <div className="text-center pt-1 border-t border-gray-100">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-navy transition-colors pt-2"
            >
              <ArrowLeft size={13} />
  ...
  // ─────────────────────────────────────────────────────────────
  // 2. AUTHENTICATED DASHBOARD (SEAMLESS PURE WHITE BACKGROUND)
  // ─────────────────────────────────────────────────────────────
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col justify-between">
      <div>
        ...
        <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur-md px-4 sm:px-8 py-3 shadow-2xs">
          <div className="mx-auto max-w-7xl flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="ml-2 hidden sm:inline-block rounded-full bg-navy-50 border border-navy/20 px-2.5 py-0.5 text-[10px] font-bold text-navy uppercase tracking-wider">
                Secretariat
              </span>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border border-gray-300 bg-white px-3.5 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 transition-all cursor-pointer shadow-2xs"
              >
                <RefreshCw size={13} className={cn(isLoading && "animate-spin text-navy")} />
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-xl border border-red-200 bg-red-50 hover:bg-red-100 px-3.5 py-2 text-xs font-bold text-red-700 transition-all cursor-pointer"
              >
                <LogOut size={13} />
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-8 pt-8 pb-12 space-y-6 bg-white">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-300 bg-white py-2 pl-10 pr-4 text-xs sm:text-sm text-gray-900 placeholder:text-gray-400 focus:border-navy focus:ring-2 focus:ring-navy/15 outline-none"
              />
              {searchTerm && (
                <button
                  type="button"
      ...
      {/* Clean Subtle Footer on Pure White */}
      <footer className="border-t border-gray-200 bg-white py-4 px-4 sm:px-8 text-center text-xs text-gray-500">
        <span>&copy; 2026 Department of Chemical Engineering, Indian Institute of Technology Indore. All rights reserved.</span>
      </footer>
